...
- 자막: 최대 2레이어, 템플릿 15종(외곽선/굵은 외곽선/회색 외곽선/그림자/반투명 박스/검정 박스/흰 박스/노란 강조/번짐+외곽선/번짐/노랑 굵은 외곽선/검정 글자/흰 반투명 박스/큰 그림자/네온), 문장별 개별 스타일, 타임라인 자막 트랙 2줄에서 구간 드래그(추가/이동/길이 조절), 폰트/크기/색/위치
